...
var init_layout_30da74b1 = __esm({
	...
	<div class="${'nav-right svelte-48agaq'}"><a href="${'/articles'}" class="${'svelte-48agaq'}">Articles</a>
		...
		_layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			$$result.css.add(css);
			return `<main class="${'svelte-1yu1tjd'}"><div class="${'content-wrapper svelte-1yu1tjd'}">${validate_component(
				Navigation,
				'Navigation'
			).$$render($$result, {}, {}, {})}
...
var init_Article_060d99cb = __esm({
	...
	<span class="${'loader_element svelte-1mc0zpb'}"></span>
		...
		Article = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			$$result.css.add(css2);
			return `<p class="${'svelte-5h8707'}"><a${add_attribute(
				'href',
				article.url,
				0
			)} target="${'_blank'}" rel="${'noopener noreferrer'}">${escape(article.title)}</a> \xB7
...
var init_index_6c3af122 = __esm({
	'.svelte-kit/output/server/chunks/index-6c3af122.js'() {
		...
		Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			$$result.css.add(css3);
			return `${
				(($$result.head += `${(($$result.title = `<title>bbarbour.dev - Home</title>`), '')}`), '')
			}
...
<div class="${'articles svelte-1f2ycfa'}">${
				loadingArticles
					? `<p>${validate_component(Loader, 'Loader').$$render($$result, {}, {}, {})}</p>`
					: ``
			}
	...
	${
		articles
			? `${each(
					articles,
					(article) =>
						`${validate_component(Article, 'Article').$$render($$result, { article }, {}, {})}`
			  )}`
			: ``
	}
...
var init_articles_d421a9e6 = __esm({
	'.svelte-kit/output/server/chunks/articles-d421a9e6.js'() {
		...
		Articles = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			...
			$$result.css.add(css4);
			return `${
				(($$result.head += `${(($$result.title = `<title>bbarbour.dev - Articles</title>`), '')}`),
				'')
			}
		...
		Projects = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			const projects = [
				...
				},
				{
					...
					description:
						'A React app that taps into the Edaman API to run queries and displays recipes in a friendly grid.',
					image: '/hunt.png'
				},
				{
					...
					description:
						'A tabletop RPG web app built in React that lets you create and store characters. Uses Firebase on the back end.',
					image: '/hack.png'
				}
			];
			$$result.css.add(css5);
...
${each(
	...
	(
		project
	) => `<div class="${'project svelte-pjbsc2'}"><div class="${'image svelte-pjbsc2'}"><img${add_attribute(
		'src',
		project.image,
		0
	)}${add_attribute('alt', project.name, 0)} class="${'svelte-pjbsc2'}"></div>
	<div class="${'text svelte-pjbsc2'}"><h3 class="${'svelte-pjbsc2'}"><a${add_attribute(
		'href',
		project.url,
		0
	)} target="${'_blank'}" rel="${'noopener noreferrer'}">${escape(project.name)}</a></h3>
...
${``}`;
		...
		manifest = {
			assets: [
				{ file: 'endless-constellation.svg', size: 1356, type: 'image/svg+xml' },
				{ file: 'favicon.png', size: 43744, type: 'image/png' },
				{ file: 'hack.png', size: 2813095, type: 'image/png' },
				{ file: 'hunt.png', size: 2182947, type: 'image/png' },
				{ file: 'saga.png', size: 2157028, type: 'image/png' }
			],
			...
			routes: [
				...
				},
				{
					...
					params: empty,
					load: () =>
						Promise.resolve().then(() => (init_articles_3443506f(), articles_3443506f_exports))
				}
			]
		};
		get_hooks = (hooks) => ({
		...
		module_lookup = {
			'src/routes/__layout.svelte': () =>
				Promise.resolve().then(() => (init_layout_30da74b1(), layout_30da74b1_exports)),
			'.svelte-kit/build/components/error.svelte': () =>
				Promise.resolve().then(() => (init_error_8dfb85ec(), error_8dfb85ec_exports)),
			'src/routes/index.svelte': () =>
				Promise.resolve().then(() => (init_index_6c3af122(), index_6c3af122_exports)),
			'src/routes/articles.svelte': () =>
				Promise.resolve().then(() => (init_articles_d421a9e6(), articles_d421a9e6_exports)),
			'src/routes/projects.svelte': () =>
				Promise.resolve().then(() => (init_projects_ef907109(), projects_ef907109_exports))
		};
		metadata_lookup = {
			'src/routes/__layout.svelte': {
				entry: 'pages/__layout.svelte-6f80eea7.js',
				css: ['assets/pages/__layout.svelte-45ead6c6.css'],
				js: ['pages/__layout.svelte-6f80eea7.js', 'chunks/vendor-8cf05b9e.js'],
				styles: []
			},
			'.svelte-kit/build/components/error.svelte': {
				entry: 'error.svelte-8747adf3.js',
				css: [],
				js: ['error.svelte-8747adf3.js', 'chunks/vendor-8cf05b9e.js'],
				styles: []
			},
			'src/routes/index.svelte': {
				entry: 'pages/index.svelte-56c0fe0c.js',
				css: ['assets/pages/index.svelte-8706dd2e.css', 'assets/Article-1dea97c9.css'],
				js: [
					'pages/index.svelte-56c0fe0c.js',
					'chunks/vendor-8cf05b9e.js',
					'chunks/Article-572db915.js'
				],
				styles: []
			},
			'src/routes/articles.svelte': {
				entry: 'pages/articles.svelte-ec9534e7.js',
				css: ['assets/pages/articles.svelte-5a3453d1.css', 'assets/Article-1dea97c9.css'],
				js: [
					'pages/articles.svelte-ec9534e7.js',
					'chunks/vendor-8cf05b9e.js',
					'chunks/Article-572db915.js'
				],
				styles: []
			...
			'src/routes/projects.svelte': {
				entry: 'pages/projects.svelte-603fa211.js',
				css: ['assets/pages/projects.svelte-34ebf6a1.css'],
				js: ['pages/projects.svelte-603fa211.js', 'chunks/vendor-8cf05b9e.js'],
				styles: []
			}
		};
	}
